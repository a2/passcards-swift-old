...
extension PasscardsServer {
    ...
    func registerDevice(request: RouterRequest, response: RouterResponse, next: @escaping () -> Void) throws {
    ...
    func getSerialNumbers(request: RouterRequest, response: RouterResponse, next: @escaping () -> Void) throws {
        guard let deviceLibraryIdentifier = request.parameters["deviceLibraryIdentifier"],
            let passTypeIdentifier = request.parameters["passTypeIdentifier"]
        else {
            try response.status(.badRequest).end()
    ...
    func getPassLatestVersion(request: RouterRequest, response: RouterResponse, next: @escaping () -> Void) throws {
    ...
    func unregisterDevice(request: RouterRequest, response: RouterResponse, next: @escaping () -> Void) throws {
        guard let deviceLibraryIdentifier = request.parameters["deviceLibraryIdentifier"],
            let passTypeIdentifier = request.parameters["passTypeIdentifier"],
            let serialNumber = request.parameters["serialNumber"]
        else {
    ...
    func logMessages(request: RouterRequest, response: RouterResponse, next: @escaping () -> Void) throws {
        guard case .some(.json(let json)) = request.body,
